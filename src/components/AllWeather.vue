<template>
    ...
    <div class="block">               
        <div class="head">  
            <div>
                <h2 class="title">Ваше местоположение</h2>  
            </div>
            <div>
                <h2>{{weather.name}}</h2>                
            </div>     
            ...
            <h2 class="title">Введите город на английском языке!</h2>     
            <div class="search">
                <div class="add">
                    <input type="text" v-model="inputCity">
                    <router-link  :to="'/weather-info/'+inputCity" ><button > Поиск </button></router-link>
                </div>
            </div>
        </div>
</div>
